...
export const equalJson = (arg1: unknown, arg2: unknown) => isEqual(cloneJson(arg1), cloneJson(arg2))
...
export const writeRows = async (sheet: GoogleSpreadsheetWorksheet, rows: Record<string, unknown>[]) => {
