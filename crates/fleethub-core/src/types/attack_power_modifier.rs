...
pub struct SpecialEnemyModifiers {
    ...
    pub army_infantry_mod: AttackPowerModifier,
    pub army_infantry_chiha_kai_mod: AttackPowerModifier,
    pub t97_tank_chiha_mod: AttackPowerModifier,
    pub t97_tank_chiha_kai_mod: AttackPowerModifier,
    pub landing_forces_mod: AttackPowerModifier,
    pub landing_forces_group_mod: AttackPowerModifier,
    pub landing_forces_t4_mod: AttackPowerModifier,
