...
pub struct FleetCutinAttacks {
    pub cutin: FleetCutin,
    pub attacks: ArrayVec<(usize, f64), 3>,
}

pub fn get_possible_fleet_cutin_vec(
    fleet: &Fleet,
    formation: Formation,
    engagement: Engagement,
    is_night: bool,
) -> Vec<FleetCutinAttacks> {
    [
        ...
        is_night
            .then(|| get_kongou_cutin(fleet, formation, engagement))
            .flatten(),
    ]
    .into_iter()
    .flatten()
...
fn get_nagato_class_cutin(fleet: &Fleet, formation: Formation) -> Option<FleetCutinAttacks> {
...
fn get_colorado_class_cutin(fleet: &Fleet, formation: Formation) -> Option<FleetCutinAttacks> {
    if !matches!(formation, Formation::ECHELON | Formation::CRUISING2) {
        return None;
    }
...
fn get_yamato_2ship_cutin(fleet: &Fleet, formation: Formation) -> Option<FleetCutinAttacks> {
...
fn get_yamato_3ship_cutin(fleet: &Fleet, formation: Formation) -> Option<FleetCutinAttacks> {
    if !matches!(formation, Formation::ECHELON | Formation::CRUISING4) {
        return None;
    }
