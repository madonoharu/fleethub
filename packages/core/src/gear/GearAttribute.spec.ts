...
describe("GearAttribute", () => {
  it("createGearAttrs", () => {
    ...
    const table: ExpectedTable = [
      ...
      [{ category: GearCategory.CbDiveBomber }, "AswGear"],
      [{ category: GearCategory.CbTorpedoBomber }, "AswGear"],
      ...
      [{ category: GearCategory.CbDiveBomber, asw: 1 }, "AswAircraft"],
      [{ category: GearCategory.CbTorpedoBomber, asw: 1 }, "AswAircraft"],
      ...
      [{ category: GearCategory.CbDiveBomber, asw: 0 }, "not", "AswAircraft"],
