...
describe("ShipMaxHp", () => {
  it("constructor", () => {
    expect(new ShipMaxHp([10, 11], undefined, false)).toMatchObject({ increase: 0, displayed: 10 })

    expect(new ShipMaxHp([10, 11], 2, false)).toMatchObject({ increase: 2, displayed: 12 })
  })
