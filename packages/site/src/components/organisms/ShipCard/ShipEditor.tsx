...
import { Flexbox, NumberInput, NumberInputProps } from "../../../components";
import { Update } from "../../../utils";

const StyledInput = styled((props: NumberInputProps) => (
  <NumberInput variant="outlined" size="small" {...props} />
))``;
  ...
  return (
    <div className={className}>
      ...
      <LineContainer>
        <StyledInput
          label="運改修"
          value={ship.luck.diff}
          onChange={(luck) => change({ luck })}
          min={0}
        />
      </LineContainer>
      <LineContainer>
