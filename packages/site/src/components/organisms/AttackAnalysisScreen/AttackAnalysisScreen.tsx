...
const AttackAnalysisScreen: React.FCX<AttackAnalysisScreenProps> = ({
  ctx,
  attacker,
  defender,
}) => {
  ...
  return (
    <div>
      ...
      >
        ...
        <Tooltip
          title={
            <HitRateDetailScreen detail={shellingAnalisis.hitRateDetail} />
          }
        >
      ...
      <AttackResultChart
        attackResultStates={shellingAnalisis.attackResultStates}
      />
    </div>
  );
};
