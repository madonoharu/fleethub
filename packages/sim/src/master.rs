...
pub struct MasterGear {
    ...
    pub anti_bomber: Option<i32>,
    pub interception: Option<i32>,
...
impl MasterGear {
    fn eval(&self, expr_str: &str) -> Option<f64> {
        let mut ns = |key: &str, args: Vec<f64>| match key {
            ...
            "anti_bomber" => option_i32_as_f64(self.anti_bomber),
            "interception" => option_i32_as_f64(self.interception),
...
mod test {
    ...
    fn test_eval() {
        let gear = MasterGear {
            ...
            evasion: Some(22),
            anti_bomber: Some(23),
            interception: Some(24),
            range: Some(25),
            radius: Some(26),
            cost: Some(27),
            special_type: Some(28),
