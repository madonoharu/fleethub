...
const NodeBattleAnalysisScreen: React.FCX<Props> = ({ plan, enemy }) => {
  ...
  const player = BattleFleetImpl.fromPlan(plan, state.player.formation, "Player")
  ...
  return (
    <div>
      <Select options={Engagements} {...getHandlers("engagement")} getOptionLabel={t} />
      ...
      >
        <div>
          <FormationSelect combined={plan.isCombined} {...getHandlers("player.formation")} />
          <BattleFleetShipSelect fleet={player} {...getHandlers("player.ship")} />
        </div>
        <Typography>VS</Typography>
        <div>
          <FormationSelect combined={enemy.isCombined} {...getHandlers("enemy.formation")} />
          <BattleFleetShipSelect fleet={enemy} {...getHandlers("enemy.ship")} />
        </div>
      </div>

      <AttackAnalysisScreen ctx={battleContext} attacker={attacker} defender={defender} />
    </div>
  )
}
