  ...
  return (
    <ScaleSVG {...getViewBox(data)}>
      <Group className={className}>
        <defs>
          <marker id="arrow" viewBox="0 -5 10 10" refX={27} markerWidth="5" markerHeight="5" orient="auto" fill="#999">
            <path d="M0,-5L10,0L0,5" />
          </marker>
        </defs>
        <Graph
          graph={data}
          linkComponent={({ link }) => <NauticalChartEdge node1={getNode(link.source)} node2={getNode(link.target)} />}
