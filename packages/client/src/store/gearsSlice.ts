import { GearState, GearKey } from "@fleethub/utils"
import { createSlice, createEntityAdapter, EntitySelectors, nanoid, EntityId } from "@reduxjs/toolkit"
...
export const gearsSelectors: EntitySelectors<GearEntity, DefaultRootState> = adapter.getSelectors(selectGearsState)
