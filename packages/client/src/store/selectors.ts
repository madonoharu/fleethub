...
export const selectGearsState = (root: DefaultRootState) => getPresentState(root).gears
export const selectShipsState = (root: DefaultRootState) => getPresentState(root).ships
