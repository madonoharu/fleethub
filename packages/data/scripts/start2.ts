...
export const getStart2 = async () => {
  const res = await axios.get("https://raw.githubusercontent.com/Tibowl/api_start2/master/start2.json")
  return res.data as Start2
}

export const getMstShips = async () => {
  const res = await axios.get("https://raw.githubusercontent.com/Tibowl/api_start2/master/parsed/api_mst_ship.json")
  return res.data as MstShip[]
}
